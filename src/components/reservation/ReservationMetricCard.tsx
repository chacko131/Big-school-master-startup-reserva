/**
 * Archivo: ReservationMetricCard.tsx
 * Responsabilidad: Renderizar una tarjeta de métrica reutilizable para vistas de reservas.
 * Tipo: UI
 */
 ...
 * @pure
 */
export function ReservationMetricCard({ label, value, caption, tone }: ReservationMetricDefinition) {
