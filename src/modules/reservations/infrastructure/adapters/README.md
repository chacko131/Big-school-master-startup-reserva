# `reservations/infrastructure/adapters`

Contiene los adaptadores técnicos del módulo `reservations`.
...
Ya existe un acceso del módulo `reservations` al cliente Prisma compartido del proyecto, conectado a Neon desde la capa de servicios.
